...
import com.example.moviedb.utils.EndlessRecyclerOnScrollListener
...
abstract class BaseLoadMoreRefreshViewModel<Item>() : BaseViewModel() {
    ...
    /**
     * handle load success for coroutines
     */
    suspend fun onLoadSuccessCoroutine(page: Int, items: List<Item>?) {
    ...
    /**
     * handle load fail for coroutines
     */
